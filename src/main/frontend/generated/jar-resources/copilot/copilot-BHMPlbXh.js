...
}, Za = process.env.NODE_ENV !== "production" ? Fa : {};
function f(e) {
  for (var t = arguments.length, r = new Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++)
    r[n - 1] = arguments[n];
  if (process.env.NODE_ENV !== "production") {
    var i = typeof e == "string" ? e : Za[e];
...
var Wa = {};
function Wr() {
  return typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : Wa;
}
var hi = Object.assign, Zt = Object.getOwnPropertyDescriptor, _ = Object.defineProperty, ir = Object.prototype, Wt = [];
Object.freeze(Wt);
var Hr = {};
Object.freeze(Hr);
var Ha = typeof Proxy < "u", Xa = /* @__PURE__ */ Object.toString();
function gi() {
  Ha || f(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function nt(e) {
...
function D(e) {
  ...
  return typeof r == "function" && r.toString() === Xa;
}
function mi(e) {
  var t = e?.constructor;
...
function Ga(e) {
  ...
  return r.length ? [].concat(t, r.filter(function(n) {
    return ir.propertyIsEnumerable.call(e, n);
  })) : t;
}
var ht = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : yi ? function(e) {
...
function W(e, t) {
  return ir.hasOwnProperty.call(e, t);
}
var Ya = Object.getOwnPropertyDescriptors || function(t) {
  var r = {};
  return ht(t).forEach(function(n) {
    r[n] = Zt(t, n);
  }), r;
};
function T(e, t) {
...
function Qe(e, t, r) {
  return t && Qa(e.prototype, t), Object.defineProperty(e, "prototype", {
    writable: !1
  }), e;
}
function Fe(e, t) {
...
function kt(e, t, r) {
  if (W(e, ie) || or(e, ie, pe({}, e[ie])), process.env.NODE_ENV !== "production" && Ht(r) && !W(e[ie], t)) {
  ...
  to(e, r, t), Ht(r) || (e[ie][t] = r);
}
function to(e, t, r) {
  if (process.env.NODE_ENV !== "production" && !Ht(t) && W(e[ie], r)) {
...
var g = /* @__PURE__ */ Symbol("mobx administration"), ve = /* @__PURE__ */ function() {
  function e(r) {
    r === void 0 && (r = process.env.NODE_ENV !== "production" ? "Atom@" + F() : "Atom"), this.name_ = void 0, this.flags_ = 0, this.observers_ = /* @__PURE__ */ new Set(), this.lastAccessedBy_ = 0, this.lowestObserverState_ = y.NOT_TRACKING_, this.onBOL = void 0, this.onBUOL = void 0, this.name_ = r;
  }
  var t = e.prototype;
...
ve.diffValueMask_ = 4;
var Jr = /* @__PURE__ */ Ie("Atom", ve);
function Oi(e, t, r) {
  t === void 0 && (t = Be), r === void 0 && (r = Be);
  var n = new ve(e);
  return t !== Be && ps(n, t), r !== Be && Xi(n, r), n;
}
function ro(e, t) {
  return aa(e, t);
}
...
function Ce(e, t, r) {
  return bt(e) ? e : Array.isArray(e) ? C.array(e, {
    name: r
    ...
    name: r
  }) : typeof e == "function" && !Pe(e) && !mt(e) ? mi(e) ? Xe(e) : gt(r, e) : e;
}
function io(e, t, r) {
  if (e == null || $e(e) || vr(e) || he(e) || Y(e))
    return e;
  if (Array.isArray(e))
    return C.array(e, {
      name: r,
...
function ao(e, t) {
  return process.env.NODE_ENV !== "production" && bt(e) && f("observable.struct should not be used with observable values"), aa(e, t) ? t : e;
}
var oo = "override";
function Ht(e) {
...
function co(e, t) {
  process.env.NODE_ENV !== "production" && sr(t, ["method", "field"]);
  var r = t.kind, n = t.name, i = t.addInitializer, a = this, o = function(c) {
    var d, u, v, h;
    return Ae((d = (u = a.options_) == null ? void 0 : u.name) != null ? d : n.toString(), c, (v = (h = a.options_) == null ? void 0 : h.autoAction) != null ? v : !1);
  };
  if (r == "field")
    return function(l) {
      var c, d = l;
      return Pe(d) || (d = o(d)), (c = a.options_) != null && c.bound && (d = d.bind(this), d.isMobxAction = !0), d;
    };
  if (r == "method") {
    var s;
    return Pe(e) || (e = o(e)), (s = this.options_) != null && s.bound && i(function() {
...
function Ei(e, t, r, n, i) {
  var a, o, s, l, c, d, u;
  i === void 0 && (i = p.safeDescriptors), uo(e, t, r, n);
  var v = n.value;
...
function po(e, t, r, n) {
  ...
  if (n === e.target_)
    return this.extend_(e, t, r, !1) === null ? 0 : 2;
  if ((i = this.options_) != null && i.bound && (!W(e.target_, t) || !mt(e.target_[t])) && this.extend_(e, t, r, !1) === null)
    return 0;
  if (mt(r.value))
    return 1;
...
function vo(e, t) {
  var r;
  process.env.NODE_ENV !== "production" && sr(t, ["method"]);
  var n = t.name, i = t.addInitializer;
  return mt(e) || (e = Xe(e)), (r = this.options_) != null && r.bound && i(function() {
...
function Ci(e, t, r, n, i, a) {
  a === void 0 && (a = p.safeDescriptors), ho(e, t, r, n);
  var o = n.value;
  if (mt(o) || (o = Xe(o)), i) {
    var s;
...
function mo(e, t, r, n) {
  return yo(e, this, t, r), e.defineComputedProperty_(t, pe({}, this.options_, {
    get: r.get,
    set: r.set
  }), n);
}
function bo(e, t) {
  process.env.NODE_ENV !== "production" && sr(t, ["getter"]);
  var r = this, n = t.name, i = t.addInitializer;
  return i(function() {
    var a = _e(this)[g], o = pe({}, r.options_, {
      get: e,
      context: this
    });
...
function xo(e, t, r, n) {
  var i, a;
  return Eo(e, this, t, r), e.defineObservableProperty_(t, r.value, (i = (a = this.options_) == null ? void 0 : a.enhancer) != null ? i : Ce, n);
}
function Oo(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
  ...
  function o(s, l) {
    var c, d, u = _e(s)[g], v = new Ee(l, (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : Ce, process.env.NODE_ENV !== "production" ? u.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
function Ao(e, t, r, n) {
  var i, a;
  if (r.get)
    return dr.make_(e, t, r, n);
  if (r.set) {
    var o = Pe(r.set) ? r.set : Ae(t.toString(), r.set);
  ...
  if (n !== e.target_ && typeof r.value == "function") {
    var s;
    if (mi(r.value)) {
      var l, c = (l = this.options_) != null && l.autoBind ? Xe.bound : Xe;
      return c.make_(e, t, r, n);
    }
    var d = (s = this.options_) != null && s.autoBind ? gt.bound : gt;
...
function So(e, t, r, n) {
  var i, a;
  if (r.get)
    return dr.extend_(e, t, r, n);
  if (r.set)
    return e.defineProperty_(t, {
      configurable: p.safeDescriptors ? e.isPlainObject_ : !0,
      set: Ae(t.toString(), r.set)
    }, n);
...
var Do = "observable", No = "observable.ref", To = "observable.shallow", Vo = "observable.struct", Si = {
  deep: !0,
  name: void 0,
...
var Vr = /* @__PURE__ */ cr(Do), zo = /* @__PURE__ */ cr(No, {
  enhancer: lr
}), Io = /* @__PURE__ */ cr(To, {
  enhancer: io
}), Uo = /* @__PURE__ */ cr(Vo, {
...
function Vt(e) {
  return e.deep === !0 ? Ce : e.deep === !1 ? lr : Mo(e.defaultDecorator);
}
function Lo(e) {
  var t;
...
function Mo(e) {
  var t, r;
  return e && (t = (r = e.options_) == null ? void 0 : r.enhancer) != null ? t : Ce;
}
function Di(e, t, r) {
  if (Ct(t))
    return Vr.decorate_20223_(e, t);
  if (ke(t)) {
    kt(e, t, Vr);
    return;
  }
  return bt(e) ? e : D(e) ? C.object(e, t, r) : Array.isArray(e) ? C.array(e, t) : Ye(e) ? C.map(e, t) : ne(e) ? C.set(e, t) : typeof e == "object" && e !== null ? e : C.box(e, t);
}
hi(Di, Pi);
var jo = {
  box: function(t, r) {
    var n = Tt(r);
    return new Ee(t, Vt(n), n.name, !0, n.equals);
  },
  array: function(t, r) {
    var n = Tt(r);
    return (p.useProxies === !1 || n.proxy === !1 ? Is : ks)(t, Vt(n), n.name);
  },
  map: function(t, r) {
    var n = Tt(r);
    return new $i(t, Vt(n), n.name);
  },
  set: function(t, r) {
    var n = Tt(r);
    return new ea(t, Vt(n), n.name);
  },
  object: function(t, r, n) {
    return Le(function() {
      return Gi(p.useProxies === !1 || n?.proxy === !1 ? _e({}, n) : xs({}, n), t, r);
    });
  },
  ref: /* @__PURE__ */ $(zo),
  shallow: /* @__PURE__ */ $(Io),
  deep: Pi,
  struct: /* @__PURE__ */ $(Uo)
}, C = /* @__PURE__ */ hi(Di, jo), Ni = "computed", Ro = "computed.struct", zr = /* @__PURE__ */ Gr(Ni), qo = /* @__PURE__ */ Gr(Ro, {
...
Object.assign(dr, zr);
dr.struct = /* @__PURE__ */ $(qo);
var fn, vn, Xt = 0, Ko = 1, Bo = (fn = (vn = /* @__PURE__ */ Zt(function() {
...
function Zo(e) {
  Xt !== e.actionId_ && f(30), Xt = e.parentActionId_, e.error_ !== void 0 && (p.suppressReactionErrors = !0), pr(e.prevAllowStateChanges_), ut(e.prevAllowStateReads_), q(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && I({
...
var Ho = "create", Ee = /* @__PURE__ */ function(e) {
  function t(n, i, a, o, s) {
    var l;
    if (a === void 0 && (a = process.env.NODE_ENV !== "production" ? "ObservableValue@" + F() : "ObservableValue"), o === void 0 && (o = !0), s === void 0 && (s = He.default), l = e.call(this, a) || this, l.enhancer = void 0, l.name_ = void 0, l.equals = void 0, l.hasUnreportedChange_ = !1, l.interceptors_ = void 0, l.changeListeners_ = void 0, l.value_ = void 0, l.dehancer = void 0, l.enhancer = i, l.name_ = a, l.equals = s, l.value_ = i(n, void 0, a), process.env.NODE_ENV !== "production" && o && P()) {
      var c;
      Se({
        type: Ho,
        object: l,
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      Ir(this) && (this.warnAboutUntrackedRead_(), R(), this.value_ = this.computeValue_(!1), q());
    else if (Mi(this), Ir(this)) {
      var n = p.trackingContext;
      this.keepAlive_ && !n && (p.trackingContext = this), this.trackAndCompute() && Qo(this), p.trackingContext = n;
    }
    var i = this.value_;
    if (qt(i))
      throw i.cause;
    ...
    return o && (this.value_ = a, process.env.NODE_ENV !== "production" && P() && Se({
    ...
    return pr(i), this.isComputing = !1, a;
  }, t.suspend_ = function() {
    this.keepAlive_ || (Ur(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== K.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
B.diffValueMask_ = 16;
var fr = /* @__PURE__ */ Ie("ComputedValue", B), y;
(function(e) {
...
function Ir(e) {
  switch (e.dependenciesState_) {
    ...
    case y.POSSIBLY_STALE_: {
      for (var t = Yr(!0), r = Ue(), n = e.observing_, i = n.length, a = 0; a < i; a++) {
        var o = n[a];
        if (fr(o)) {
...
function Vi(e, t, r) {
  ...
  return p.inBatch--, p.trackingDerivation = i, Go(e), Jo(e), ut(n), a;
}
function Jo(e) {
...
function Go(e) {
  for (var t = e.observing_, r = e.observing_ = e.newObserving_, n = y.UP_TO_DATE_, i = 0, a = e.unboundDepsCount_, o = 0; o < a; o++) {
    var s = r[o];
  ...
  for (; i--; ) {
    var c = r[i];
    c.diffValue === 1 && (c.diffValue = 0, Yo(c, e));
  }
...
}, wr = !0, p = /* @__PURE__ */ function() {
  var e = /* @__PURE__ */ Wr();
  return e.__mobxInstanceCount > 0 && !e.__mobxGlobals && (wr = !1), e.__mobxGlobals && e.__mobxGlobals.version !== new yr().version && (wr = !1), wr ? e.__mobxGlobals ? (e.__mobxInstanceCount += 1, e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}), e.__mobxGlobals) : (e.__mobxInstanceCount = 1, e.__mobxGlobals = /* @__PURE__ */ new yr()) : (setTimeout(function() {
    f(35);
  }, 1), new yr());
}();
function Yo(e, t) {
...
function ji(e) {
  e.lowestObserverState_ !== y.STALE_ && (e.lowestObserverState_ = y.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === y.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== K.NONE && Ri(t, e), t.onBecomeStale_()), t.dependenciesState_ = y.STALE_;
  }));
}
function Qo(e) {
  e.lowestObserverState_ !== y.STALE_ && (e.lowestObserverState_ = y.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === y.POSSIBLY_STALE_ ? (t.dependenciesState_ = y.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== K.NONE && Ri(t, e)) : t.dependenciesState_ === y.UP_TO_DATE_ && (e.lowestObserverState_ = y.UP_TO_DATE_);
  }));
}
function _o(e) {
...
function Ri(e, t) {
  if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === K.BREAK) {
    var r = [];
    qi(fs(e), r, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var ee = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    if (!this.isDisposed) {
      ...
      var n = p.trackingContext;
      if (p.trackingContext = this, Ir(this)) {
        this.isTrackPending = !0;
        try {
          this.onInvalidate_(), process.env.NODE_ENV !== "production" && this.isTrackPending && P() && Se({
            name: this.name_,
    ...
    if (!this.isDisposed) {
      ...
      p.trackingContext = o, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && Ur(this), qt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && I({
        time: Date.now() - a
      }), q();
    }
    ...
    p.suppressReactionErrors ? process.env.NODE_ENV !== "production" && console.warn("[mobx] (error in reaction '" + this.name_ + "' suppressed, fix error of causing action below)") : console.error(a, n), process.env.NODE_ENV !== "production" && P() && Se({
      type: "error",
      name: this.name_,
      message: a,
      error: "" + n
    ...
    this.isDisposed || (this.isDisposed = !0, this.isRunning || (R(), Ur(this), q()));
...
var gn = 100, es = function(t) {
  return t();
};
function Ki() {
  p.inBatch > 0 || p.isRunningReactions || es(ts);
}
function ts() {
...
var Gt = /* @__PURE__ */ Ie("Reaction", ee);
function P() {
...
function I(e) {
  process.env.NODE_ENV !== "production" && Se(e ? pe({}, e, {
    type: "report-end",
    spyReportEnd: !0
  }) : rs);
}
function ns(e) {
  ...
  }) : (p.spyListeners.push(e), Xr(function() {
    p.spyListeners = p.spyListeners.filter(function(t) {
      return t !== e;
    });
  }));
}
var Qr = "action", is = "action.bound", Bi = "autoAction", as = "autoAction.bound", Fi = "<unnamed action>", Lr = /* @__PURE__ */ At(Qr), os = /* @__PURE__ */ At(is, {
  bound: !0
}), Mr = /* @__PURE__ */ At(Bi, {
  autoAction: !0
}), ss = /* @__PURE__ */ At(as, {
...
function Zi(e) {
  var t = function(n, i) {
    if (k(n))
      return Ae(n.name || Fi, n, e);
    if (k(i))
      return Ae(n, i, e);
    if (Ct(i))
      return (e ? Mr : Lr).decorate_20223_(n, i);
    if (ke(i))
      return kt(n, i, e ? Mr : Lr);
    if (ke(n))
      return $(At(e ? Bi : Qr, {
        name: n,
        autoAction: e
...
var xe = /* @__PURE__ */ Zi(!1);
Object.assign(xe, Lr);
var gt = /* @__PURE__ */ Zi(!0);
Object.assign(gt, Mr);
xe.bound = /* @__PURE__ */ $(os);
gt.bound = /* @__PURE__ */ $(ss);
function md(e) {
...
function Wi(e, t) {
  var r, n, i, a;
  t === void 0 && (t = Hr), process.env.NODE_ENV !== "production" && (k(e) || f("Autorun expects a function as first argument"), Pe(e) && f("Autorun does not accept actions since actions are untrackable"));
...
function _r(e, t, r) {
  var n, i, a;
  r === void 0 && (r = Hr), process.env.NODE_ENV !== "production" && ((!k(e) || !k(t)) && f("First and second argument to reaction should be functions"), D(r) || f("Third argument of reactions should be an object"));
  var o = (n = r.name) != null ? n : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = xe(o, r.onError ? cs(r.onError, t) : t), l = !r.scheduler && !r.delay, c = Hi(r), d = !0, u = !1, v, h = r.compareStructural ? He.structural : r.equals || He.default, m = new ee(o, function() {
    d || l ? O() : u || (u = !0, c(O));
...
function Gi(e, t, r, n) {
  process.env.NODE_ENV !== "production" && (arguments.length > 4 && f("'extendObservable' expected 2-4 arguments"), typeof e != "object" && f("'extendObservable' expects an object as first argument"), he(e) && f("'extendObservable' should not be used on maps, use map.merge instead"), D(t) || f("'extendObservable' only accepts plain objects as second argument"), (bt(t) || bt(r)) && f("Extending an object with another observable (object) is not supported"));
  var i = Ya(t);
  return Le(function() {
    var a = _e(e, n)[g];
    ht(i).forEach(function(o) {
      a.extend_(
        o,
        i[o],
...
function Yi(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = vs(e.observing_).map(Yi)), t;
}
function vs(e) {
...
var xr = /* @__PURE__ */ ki("flow"), gs = /* @__PURE__ */ ki("flow.bound", {
  bound: !0
}), Xe = /* @__PURE__ */ Object.assign(function(t, r) {
  if (Ct(r))
    return xr.decorate_20223_(t, r);
  if (ke(r))
    return kt(t, r, xr);
  ...
  var n = t, i = n.name || "<unnamed flow>", a = function() {
    var s = this, l = arguments, c = ++hs, d = xe(i + " - runid: " + c + " - init", n).apply(s, l), u, v = void 0, h = new Promise(function(m, O) {
      var A = 0;
      u = O;
      function G(N) {
        v = void 0;
        var le;
        try {
          le = xe(i + " - runid: " + c + " - yield " + A++, d.next).call(d, N);
        } catch (ge) {
          return O(ge);
        }
        rt(le);
      ...
      function Me(N) {
        ...
        var le;
        try {
          le = xe(i + " - runid: " + c + " - yield " + A++, d.throw).call(d, N);
        } catch (ge) {
          return O(ge);
        }
        rt(le);
      ...
      function rt(N) {
        ...
        return N.done ? m(N.value) : (v = Promise.resolve(N.value), v.then(G, Me));
      }
      G(void 0);
    });
    return h.cancel = xe(i + " - runid: " + c + " - cancel", function() {
      try {
        v && mn(v);
        var m = d.return(void 0), O = Promise.resolve(m.value);
        O.then(Be, Be), mn(O), u(new Qi());
      } catch (A) {
        u(A);
      }
    }), h;
...
function ms(e, t) {
  return e ? $e(e) || !!e[g] || Jr(e) || Gt(e) || fr(e) : !1;
}
function bt(e) {
  return process.env.NODE_ENV !== "production" && arguments.length !== 1 && f("isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property"), ms(e);
}
function bs() {
  if (process.env.NODE_ENV !== "production") {
...
var ws = {
  has: function(t, r) {
    return process.env.NODE_ENV !== "production" && p.trackingDerivation && nt("detect new properties using the 'in' operator. Use 'has' from 'mobx' instead."), me(t).has_(r);
  },
  get: function(t, r) {
    return me(t).get_(r);
  },
  set: function(t, r, n) {
    var i;
    return ke(r) ? (process.env.NODE_ENV !== "production" && !me(t).values_.has(r) && nt("add a new observable property through direct assignment. Use 'set' from 'mobx' instead."), (i = me(t).set_(r, n, !0)) != null ? i : !0) : !1;
  },
  deleteProperty: function(t, r) {
    var n;
    return process.env.NODE_ENV !== "production" && nt("delete properties from an observable object. Use 'remove' from 'mobx' instead."), ke(r) ? (n = me(t).delete_(r, !0)) != null ? n : !0 : !1;
  },
  defineProperty: function(t, r, n) {
    var i;
    return process.env.NODE_ENV !== "production" && nt("define property on an observable object. Use 'defineProperty' from 'mobx' instead."), (i = me(t).defineProperty_(r, n)) != null ? i : !0;
  },
  ownKeys: function(t) {
    return process.env.NODE_ENV !== "production" && p.trackingDerivation && nt("iterate keys to detect added / removed properties. Use 'keys' from 'mobx' instead."), me(t).ownKeys_();
  },
...
function xs(e, t) {
  var r, n;
  return gi(), e = _e(e, t), (n = (r = e[g]).proxy_) != null ? n : r.proxy_ = new Proxy(e, ws);
}
function M(e) {
...
function Dt(e, t, r) {
  return process.env.NODE_ENV !== "production" && (!D(e) && !D(Object.getPrototypeOf(e)) && f("'makeAutoObservable' can only be used for classes that don't have a superclass"), $e(e) && f("makeAutoObservable can only be used on objects not already made observable")), D(e) ? Gi(e, e, t, r) : (Le(function() {
    var n = _e(e, r)[g];
    if (!e[Or]) {
      var i = Object.getPrototypeOf(e), a = new Set([].concat(ht(e), ht(i)));
      a.delete("constructor"), a.delete(g), or(i, Or, a);
    }
    e[Or].forEach(function(o) {
      return n.make_(
        o,
        // must pass "undefined" for { key: undefined }
        t && o in t ? t[o] : !0
...
var bn = "splice", Z = "update", Os = 1e4, Es = {
  get: function(t, r) {
    var n = t[g];
    return r === g ? n : r === "length" ? n.getArrayLength_() : typeof r == "string" && !isNaN(r) ? n.get_(parseInt(r)) : W(Yt, r) ? Yt[r] : t[r];
  },
  set: function(t, r, n) {
    var i = t[g];
  ...
  function e(r, n, i, a) {
    r === void 0 && (r = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), this.owned_ = void 0, this.legacyMode_ = void 0, this.atom_ = void 0, this.values_ = [], this.interceptors_ = void 0, this.changeListeners_ = void 0, this.enhancer_ = void 0, this.dehancer = void 0, this.proxy_ = void 0, this.lastKnownLength_ = 0, this.owned_ = i, this.legacyMode_ = a, this.atom_ = new ve(r), this.enhancer_ = function(o, s) {
  ...
  return t.dehanceValue_ = function(n) {
    ...
    process.env.NODE_ENV !== "production" && o && z(l), this.atom_.reportChanged(), s && X(this, l), process.env.NODE_ENV !== "production" && o && I();
...
function ks(e, t, r, n) {
  return r === void 0 && (r = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), n === void 0 && (n = !1), gi(), Le(function() {
    var i = new $r(r, t, n, !1);
    bi(i.values_, g, i);
    var a = new Proxy(i.values_, Es);
...
var Cs = /* @__PURE__ */ Ie("ObservableArrayAdministration", $r);
function vr(e) {
  return ar(e) && Cs(e[g]);
}
var As = {}, de = "add", Qt = "delete", $i = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var a = this;
    n === void 0 && (n = Ce), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + F() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[g] = As, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = n, this.name_ = i, k(Map) || f(18), Le(function() {
  ...
  return t.has_ = function(n) {
    ...
    if (!a) {
      var o = a = new Ee(this.has_(n), lr, process.env.NODE_ENV !== "production" ? this.name_ + "." + Nr(n) + "?" : "ObservableMap.key?", !1);
    ...
    if (this.has_(n)) {
      ...
      }), s && X(this, l), process.env.NODE_ENV !== "production" && o && I(), !0;
    }
    return !1;
    ...
    if (i = a.prepareNewValue_(i), i !== p.UNCHANGED) {
      ...
      process.env.NODE_ENV !== "production" && o && z(l), a.setNewValue_(i), s && X(this, l), process.env.NODE_ENV !== "production" && o && I();
    }
  }, t.addValue_ = function(n, i) {
    var a = this;
    Q(this.keysAtom_), ae(function() {
      var c, d = new Ee(i, a.enhancer_, process.env.NODE_ENV !== "production" ? a.name_ + "." + Nr(n) : "ObservableMap.key", !1);
    ...
    process.env.NODE_ENV !== "production" && o && z(l), s && X(this, l), process.env.NODE_ENV !== "production" && o && I();
  }, t.get = function(n) {
    ...
    for (var a = Fe(this), o; !(o = a()).done; ) {
      var s = o.value, l = s[0], c = s[1];
      n.call(i, c, l, this);
    }
  }, t.merge = function(n) {
    var i = this;
    return he(n) && (n = new Map(n)), ae(function() {
      D(n) ? Ga(n).forEach(function(a) {
        return i.set(a, n[a]);
      }) : Array.isArray(n) ? n.forEach(function(a) {
        var o = a[0], s = a[1];
        return i.set(o, s);
      }) : Ye(n) ? (Ja(n) || f(19, n), n.forEach(function(a, o) {
        return i.set(o, a);
      })) : n != null && f(20, n);
    }), this;
  }, t.clear = function() {
    ...
    ae(function() {
      zi(function() {
        for (var i = Fe(n.keys()), a; !(a = i()).done; ) {
          var o = a.value;
          n.delete(o);
        }
      });
    ...
    var i = this;
    return ae(function() {
      for (var a = Ss(n), o = /* @__PURE__ */ new Map(), s = !1, l = Fe(i.data_.keys()), c; !(c = l()).done; ) {
        var d = c.value;
        if (!a.has(d)) {
          var u = i.delete(d);
          if (u)
      ...
      for (var h = Fe(a.entries()), m; !(m = h()).done; ) {
        var O = m.value, A = O[0], G = O[1], Me = i.data_.has(A);
        if (i.set(A, G), i.data_.has(A)) {
          var rt = i.data_.get(A);
          o.set(A, rt), Me || (s = !0);
        }
      }
      if (!s)
        if (i.data_.size !== o.size)
          ...
          for (var N = i.data_.keys(), le = o.keys(), ge = N.next(), un = le.next(); !ge.done; ) {
            if (ge.value !== un.value) {
              i.keysAtom_.reportChanged();
              break;
            }
            ge = N.next(), un = le.next();
          }
      i.data_ = o;
    }), this;
  }, t.toString = function() {
...
}(), he = /* @__PURE__ */ Ie("ObservableMap", $i);
function yn(e) {
  return e[Symbol.toStringTag] = "MapIterator", tn(e);
}
function Ss(e) {
  if (Ye(e) || he(e))
    return e;
...
var Ps = {}, ea = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var a = this;
    n === void 0 && (n = Ce), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + F() : "ObservableSet"), this.name_ = void 0, this[g] = Ps, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, k(Set) || f(22), this.enhancer_ = function(o, s) {
      return n(o, s, i);
    }, Le(function() {
  ...
  return t.dehanceValue_ = function(n) {
    ...
    ae(function() {
      zi(function() {
        for (var i = Fe(n.data_.values()), a; !(a = i()).done; ) {
          var o = a.value;
          n.delete(o);
        }
      });
    ...
    if (!this.has(n)) {
      ...
      o && process.env.NODE_ENV !== "production" && z(l), s && X(this, l), o && process.env.NODE_ENV !== "production" && I();
    }
    return this;
  }, t.delete = function(n) {
    var i = this;
    ...
    if (this.has(n)) {
      ...
      }), s && X(this, l), o && process.env.NODE_ENV !== "production" && I(), !0;
    }
    return !1;
  }, t.has = function(n) {
...
}(), Y = /* @__PURE__ */ Ie("ObservableSet", ea);
function wn(e) {
  return e[Symbol.toStringTag] = "SetIterator", tn(e);
}
var xn = /* @__PURE__ */ Object.create(null), On = "remove", jr = /* @__PURE__ */ function() {
  function e(r, n, i, a) {
    n === void 0 && (n = /* @__PURE__ */ new Map()), a === void 0 && (a = Co), this.target_ = void 0, this.values_ = void 0, this.name_ = void 0, this.defaultAnnotation_ = void 0, this.keysAtom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.proxy_ = void 0, this.isPlainObject_ = void 0, this.appliedAnnotations_ = void 0, this.pendingKeys_ = void 0, this.target_ = r, this.values_ = n, this.name_ = i, this.defaultAnnotation_ = a, this.keysAtom_ = new ve(process.env.NODE_ENV !== "production" ? this.name_ + ".keys" : "ObservableObject.keys"), this.isPlainObject_ = D(this.target_), process.env.NODE_ENV !== "production" && !oa(this.defaultAnnotation_) && f("defaultAnnotation must be valid annotation"), process.env.NODE_ENV !== "production" && (this.appliedAnnotations_ = {});
  }
  var t = e.prototype;
  return t.getObservablePropValue_ = function(n) {
    ...
    if (i = a.prepareNewValue_(i), i !== p.UNCHANGED) {
      ...
      process.env.NODE_ENV !== "production" && l && z(c), a.setNewValue_(i), s && X(this, c), process.env.NODE_ENV !== "production" && l && I();
    }
    return !0;
  }, t.get_ = function(n) {
    ...
    return i || (i = new Ee(n in this.target_, lr, process.env.NODE_ENV !== "production" ? this.name_ + "." + Nr(n) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(n, i)), i.get();
    ...
    try {
      ...
      if (o) {
        ...
        _(this.target_, n, d);
      var u = new Ee(i, a, process.env.NODE_ENV !== "production" ? this.name_ + "." + n.toString() : "ObservableObject.key", !1);
    ...
    try {
      ...
      if (!c && (s || l)) {
        var u;
        d = (u = Zt(this.target_, n)) == null ? void 0 : u.value;
      }
      if (i) {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[n], c && (this.values_.delete(n), c instanceof Ee && (d = c.value_), ji(c)), this.keysAtom_.reportChanged(), (o = this.pendingKeys_) == null || (o = o.get(n)) == null || o.set(n in this.target_), s || l) {
        var v = {
          type: On,
          observableKind: "object",
          object: this.proxy_ || this.target_,
        ...
        process.env.NODE_ENV !== "production" && l && z(v), s && X(this, v), process.env.NODE_ENV !== "production" && l && I();
      }
    } finally {
      q();
    }
    ...
    if (o || s) {
      ...
      process.env.NODE_ENV !== "production" && s && z(l), o && X(this, l), process.env.NODE_ENV !== "production" && s && I();
    }
...
function _e(e, t) {
  var r;
  if (process.env.NODE_ENV !== "production" && t && $e(e) && f("Options can't be provided for already observable objects."), W(e, g))
    return process.env.NODE_ENV !== "production" && !(ia(e) instanceof jr) && f("Cannot convert '" + _t(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var n = (r = t?.name) != null ? r : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + F() : "ObservableObject", i = new jr(e, /* @__PURE__ */ new Map(), String(n), Lo(t));
  return or(e, g, i), e;
}
var Ds = /* @__PURE__ */ Ie("ObservableObjectAdministration", jr);
function En(e) {
  return xn[e] || (xn[e] = {
    get: function() {
...
function Cn(e, t, r) {
  if (process.env.NODE_ENV !== "production" && !oa(t) && f("Cannot annotate '" + e.name_ + "." + r.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Ht(t) && W(e.appliedAnnotations_, r)) {
...
var Ns = /* @__PURE__ */ ra(0), Ts = /* @__PURE__ */ function() {
  var e = !1, t = {};
...
Vs(ta, Array.prototype);
var en = /* @__PURE__ */ function(e) {
  function t(n, i, a, o) {
    var s;
    return a === void 0 && (a = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), o === void 0 && (o = !1), s = e.call(this) || this, Le(function() {
      var l = new $r(a, i, o, !0);
      l.proxy_ = s, bi(s, g, l), n && n.length && s.spliceWithArray(0, 0, n), Ts && Object.defineProperty(s, "0", Ns);
    }), s;
  }
  xi(t, e);
  var r = t.prototype;
...
function Je(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (he(e)) {
      ...
      return r || f(25, t, _t(e)), r;
    }
    if ($e(e)) {
      if (!t)
        return f(26);
      var n = e[g].values_.get(t);
      return n || f(27, t, _t(e)), n;
    }
    if (Jr(e) || fr(e) || Gt(e))
      return e;
  } else if (k(e) && Gt(e[g]))
...
function ia(e, t) {
  if (e || f(29), Jr(e) || fr(e) || Gt(e) || he(e) || Y(e))
    return e;
  if (e[g])
    return e[g];
  f(24, e);
...
function Sn(e) {
  return vr(e) ? e.slice() : Ye(e) || he(e) || ne(e) || Y(e) ? Array.from(e.entries()) : e;
}
var Pn, Us = ((Pn = Wr().Iterator) == null ? void 0 : Pn.prototype) || {};
function tn(e) {
  return e[Symbol.iterator] = Ls, Object.assign(Object.create(Us), e);
}
function Ls() {
  return this;
}
...
var et = /* @__PURE__ */ ((e) => (e.INFORMATION = "information", e.WARNING = "warning", e.ERROR = "error", e))(et || {});
const Ms = Symbol.for("react.portal"), js = Symbol.for("react.fragment"), Rs = Symbol.for("react.strict_mode"), qs = Symbol.for("react.profiler"), Ks = Symbol.for("react.provider"), Bs = Symbol.for("react.context"), sa = Symbol.for("react.forward_ref"), Fs = Symbol.for("react.suspense"), Zs = Symbol.for("react.suspense_list"), Ws = Symbol.for("react.memo"), Hs = Symbol.for("react.lazy");
function Xs(e, t, r) {
...
function bd() {
  ...
  return Array.from(document.body.querySelectorAll("*")).flatMap(Ys).filter(Js).filter((r) => !r.fileName.includes("frontend/generated/")).forEach((r) => e.add(r.fileName)), Array.from(e);
}
function Js(e) {
  return !!e && e.fileName;
}
...
function ct(e) {
  const t = e.type;
  return t?.$$typeof === sa && !t.displayName && e.child ? ct(e.child) : $t(e.type) ?? $t(e.elementType) ?? "???";
}
function $s() {
  const e = Array.from(document.querySelectorAll("body > *")).flatMap((r) => r[_s()]).find((r) => r), t = De(e);
  return De(t?.child);
}
function el(e) {
  const t = [];
...
function nl(e) {
  return typeof e.type != "function" || ca(e) ? !1 : !!(er(e) || Gs(e));
}
function ca(e) {
  if (!e)
    return !1;
...
const hr = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r), Ne = "copilot-", il = "25.0.8", al = "undefined", yd = "attention-required", wd = "https://plugins.jetbrains.com/plugin/23758-vaadin", xd = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Od = "https://marketplace.eclipse.org/content/vaadin-tools";
function Ed(e) {
...
const gl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, pa = (e) => {
  const t = [];
  let r = Vn(e);
  for (; r; )
    t.push(r), r = Vn(r);
  ...
  let r = e;
  for (; !(r instanceof HTMLElement && r.localName === `${Ne}main`); ) {
    if (!r.isConnected)
      return null;
    if (r.parentNode)
      r = r.parentNode;
...
function ue(e) {
  if (e instanceof Node) {
    const t = pa(e);
    return e instanceof HTMLElement && t.push(e), t.map((r) => r.localName).some((r) => r.startsWith(Ne));
  }
  return !1;
}
function zn(e) {
...
function bl(e) {
  return e instanceof Element && typeof e.getBoundingClientRect == "function" ? e.getBoundingClientRect() : yl(e);
}
function yl(e) {
...
function El(e, t) {
  const r = xl(e), n = r.getBoundingClientRect();
...
function Vd(e) {
  const t = fa(e), r = ml(t);
  !t.every((i) => Ol(i, r)) && t.length > 0 && t[0].scrollIntoView();
}
function fa(e) {
  const t = e;
  if (!t)
...
function Cl(e) {
  ...
  !gl(document.documentElement.getBoundingClientRect(), t, r);
}
function Ln(e) {
...
function Mn(e) {
  return Al(e) ? (e.close(), !0) : e.localName === "vaadin-popover" ? (e.opened = !1, !0) : !1;
}
...
class Sl {
  constructor() {
    this.openedOverlayOwners = /* @__PURE__ */ new Set(), this.overlayCloseEventListener = (t) => {
      ue(t.detail?.overlay) || (window.Vaadin.copilot._uiState.active || ue(t.detail.sourceEvent?.target)) && (t.preventDefault(), t.stopImmediatePropagation());
    };
  }
  /**
...
class Dl {
  constructor() {
    this._panels = [], this._attentionRequiredPanelTag = null, this._floatingPanelsZIndexOrder = [], this.renderedPanels = /* @__PURE__ */ new Set(), this.customTags = /* @__PURE__ */ new Map(), Dt(this), this.restorePositions();
  }
  shouldRender(t) {
    return this.renderedPanels.has(t);
  }
  restorePositions() {
    const t = Ze.getPanelConfigurations();
  ...
  updatePanel(t, r) {
    ...
    if (i) {
      for (const a in r)
        i[a] = r[a];
      i.expanded && this.renderedPanels.add(i.tag), r.floating === !1 && (this._floatingPanelsZIndexOrder = this._floatingPanelsZIndexOrder.filter((a) => a !== t)), this._panels = n, Ze.savePanelConfigurations(this._panels);
    }
  }
  updateOrders(t) {
    ...
    }), this._panels = r, Ze.savePanelConfigurations(r);
  }
  removePanel(t) {
    const r = this._panels.findIndex((n) => n.tag === t);
    r < 0 || (this._panels.splice(r, 1), Ze.savePanelConfigurations(this._panels));
  }
...
class Nl {
  constructor() {
    this.supportsHilla = !0, this.springSecurityEnabled = !1, this.springJpaDataEnabled = !1, this.springJpaDatasourceInitialization = !1, this.springApplication = !1, this.urlPrefix = "", this.serverVersions = [], this.clientVersions = [{ name: "Browser", version: navigator.userAgent }], Dt(this);
  }
  setSupportsHilla(t) {
...
class Tl {
  constructor() {
    this.palette = { components: [] }, Dt(this), this.initializer = new ba(), this.initializer.promise.then(() => {
      _r(
        () => JSON.stringify(this),
        () => {
  ...
  addPaletteCustomComponent(t) {
    return (this.palette?.components ?? []).find((i) => kr(i, t)) ? !1 : (this.palette || (this.palette = { components: [] }), this.palette = JSON.parse(JSON.stringify(this.palette)), this.palette.components.push(t), !0);
  }
  ...
  updatePaletteCustomComponent(t, r) {
    if (!this.palette || !this.palette.components)
      return;
    const n = [...this.palette.components], i = n.findIndex((a) => kr(a, t));
...
window.Vaadin.copilot._uiState = new hl();
window.Vaadin.copilot.eventbus = new Ba();
window.Vaadin.copilot.overlayManager = new Sl();
window.Vaadin.copilot._machineState = new Pl();
window.Vaadin.copilot._storedProjectState = new Tl();
window.Vaadin.copilot._sectionPanelUiState = new Dl();
window.Vaadin.copilot._earlyProjectState = new Nl();
/**
 * @license
...
const L = (e) => new ya(typeof e == "string" ? e : e + "", void 0, an), zl = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ul, defineProperty: Ll, getOwnPropertyDescriptor: Ml, getOwnPropertyNames: jl, getOwnPropertySymbols: Rl, getPrototypeOf: ql } = Object, gr = globalThis, Fn = gr.trustedTypes, Kl = Fn ? Fn.emptyScript : "", Bl = gr.reactiveElementPolyfillSupport, pt = (e, t) => e, Br = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Kl : null;
      break;
  ...
  return r;
} }, wa = (e, t) => !Ul(e, t), Zn = { attribute: !0, type: String, converter: Br, reflect: !1, useDefault: !1, hasChanged: wa };
Symbol.metadata ??= Symbol("metadata"), gr.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let Ke = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, r, n) {
    const { get: i, set: a } = Ml(this.prototype, t) ?? { get() {
      return this[r];
    }, set(o) {
      this[r] = o;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(pt("properties"))) {
      const r = this.properties, n = [...jl(r), ...Rl(r)];
  ...
  createRenderRoot() {
    ...
    return Il(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
  ...
  _$ET(t, r) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const a = (n.converter?.toAttribute !== void 0 ? n.converter : Br).toAttribute(r, n.type);
  ...
  _$AK(t, r) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const a = n.getPropertyOptions(i), o = typeof a.converter == "function" ? { fromAttribute: a.converter } : a.converter?.fromAttribute !== void 0 ? a.converter : Br;
...
Ke.elementStyles = [], Ke.shadowRootOptions = { mode: "open" }, Ke[pt("elementProperties")] = /* @__PURE__ */ new Map(), Ke[pt("finalized")] = /* @__PURE__ */ new Map(), Bl?.({ ReactiveElement: Ke }), (gr.reactiveElementVersions ??= []).push("2.1.0");
const Re = Symbol("LitMobxRenderReaction"), Wn = Symbol("LitMobxRequestUpdate");
function Fl(e, t) {
  var r, n;
  return n = class extends e {
    ...
    connectedCallback() {
      ...
      this[Re] = new t(`${a}.update()`, this[Wn]), this.hasUpdated && this.requestUpdate();
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this[Re] && (this[Re].dispose(), this[Re] = void 0);
    }
    update(a) {
      this[Re] ? this[Re].track(super.update.bind(this, a)) : super.update(a);
    }
  }, r = Wn, n;
}
function Zl(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const on = globalThis, nr = on.trustedTypes, Hn = nr ? nr.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, xa = "$lit$", ce = `lit$${Math.random().toFixed(9).slice(2)}$`, Oa = "?" + ce, Wl = `<${Oa}>`, Te = document, xt = () => Te.createComment(""), Ot = (e) => e === null || typeof e != "object" && typeof e != "function", sn = Array.isArray, Hl = (e) => sn(e) || typeof e?.[Symbol.iterator] == "function", Cr = `[ 	
\f\r]`, it = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xn = /-->/g, Jn = />/g, be = RegExp(`>|${Cr}(?:([^\\s"'>=/]+)(${Cr}*=${Cr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Gn = /'/g, Yn = /"/g, Ea = /^(?:script|style|textarea|title)$/i, ka = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), Ve = ka(1), Md = ka(2), fe = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), Qn = /* @__PURE__ */ new WeakMap(), Oe = Te.createTreeWalker(Te, 129);
function Ca(e, t) {
...
const Xl = (e, t) => {
  ...
  let i, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = it;
  for (let s = 0; s < r; s++) {
    const l = e[s];
    let c, d, u = -1, v = 0;
    for (; v < l.length && (o.lastIndex = v, d = o.exec(l), d !== null); ) v = o.lastIndex, o === it ? d[1] === "!--" ? o = Xn : d[1] !== void 0 ? o = Jn : d[2] !== void 0 ? (Ea.test(d[2]) && (i = RegExp("</" + d[2], "g")), o = be) : d[3] !== void 0 && (o = be) : o === be ? d[0] === ">" ? (o = i ?? it, u = -1) : d[1] === void 0 ? u = -2 : (u = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? be : d[3] === '"' ? Yn : Gn) : o === Yn || o === Gn ? o = be : o === Xn || o === Jn ? o = it : (o = be, i = void 0);
    const h = o === be && e[s + 1].startsWith("/>") ? " " : "";
    a += o === it ? l + Wl : u >= 0 ? (n.push(c), l.slice(0, u) + xa + l.slice(u) + ce + h) : l + ce + (u === -2 ? s : h);
  }
...
class Et {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    this.parts = [];
    let a = 0, o = 0;
    const s = t.length - 1, l = this.parts, [c, d] = Xl(t, r);
    if (this.el = Et.createElement(c, n), Oe.currentNode = this.el.content, r === 2 || r === 3) {
    ...
    for (; (i = Oe.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(xa)) {
          const v = d[o++], h = i.getAttribute(u).split(ce), m = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: a, name: m[2], strings: h, ctor: m[1] === "." ? Gl : m[1] === "?" ? Yl : m[1] === "@" ? Ql : mr }), i.removeAttribute(u);
        } else u.startsWith(ce) && (l.push({ type: 6, index: a }), i.removeAttribute(u));
        if (Ea.test(i.tagName)) {
          const u = i.textContent.split(ce), v = u.length - 1;
          if (v > 0) {
            i.textContent = nr ? nr.emptyScript : "";
            for (let h = 0; h < v; h++) i.append(u[h], xt()), Oe.nextNode(), l.push({ type: 2, index: ++a });
            i.append(u[v], xt());
          }
        }
        ...
        let u = -1;
        for (; (u = i.data.indexOf(ce, u + 1)) !== -1; ) l.push({ type: 7, index: a }), u += ce.length - 1;
      }
      a++;
    }
  }
...
function Ge(e, t, r = e, n) {
  ...
  return i?.constructor !== a && (i?._$AO?.(!1), a === void 0 ? i = void 0 : (i = new a(e), i._$AT(e, r, n)), n !== void 0 ? (r._$Co ??= [])[n] = i : r._$Cl = i), i !== void 0 && (t = Ge(e, i._$AS(e, t.values), i, n)), t;
}
let Jl = class {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: n } = this._$AD, i = (t?.creationScope ?? Te).importNode(r, !0);
    Oe.currentNode = i;
    let a = Oe.nextNode(), o = 0, s = 0, l = n[0];
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new tt(a, a.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(a, l.name, l.strings, this, t) : l.type === 6 && (c = new _l(a, this, t)), this._$AV.push(c), l = n[++s];
      }
      o !== l?.index && (a = Oe.nextNode(), o++);
    }
...
class tt {
  ...
  _$AI(t, r = this) {
    t = Ge(this, t, r), Ot(t) ? t === E || t == null || t === "" ? (this._$AH !== E && this._$AR(), this._$AH = E) : t !== this._$AH && t !== fe && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Hl(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== E && Ot(this._$AH) ? this._$AA.nextSibling.data = t : this.T(Te.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: r, _$litType$: n } = t, i = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = Et.createElement(Ca(n.h, n.h[0]), this.options)), n);
    if (this._$AH?._$AD === i) this._$AH.p(r);
    else {
      const a = new Jl(i, this), o = a.u(this.options);
      a.p(r), this.T(o), this._$AH = a;
    }
  }
  _$AC(t) {
    let r = Qn.get(t.strings);
    return r === void 0 && Qn.set(t.strings, r = new Et(t)), r;
  }
  k(t) {
    sn(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let n, i = 0;
    for (const a of t) i === r.length ? r.push(n = new tt(this.O(xt()), this.O(xt()), this, this.options)) : n = r[i], n._$AI(a), i++;
...
class mr {
  ...
  _$AI(t, r = this, n, i) {
    ...
    let o = !1;
    if (a === void 0) t = Ge(this, t, r, 0), o = !Ot(t) || t !== this._$AH && t !== fe, o && (this._$AH = t);
    else {
      const s = t;
      let l, c;
      for (t = a[0], l = 0; l < a.length - 1; l++) c = Ge(this, s[n + l], r, l), c === fe && (c = this._$AH[l]), o ||= !Ot(c) || c !== this._$AH[l], c === E ? t = E : t !== E && (t += (c ?? "") + a[l + 1]), this._$AH[l] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
class Ql extends mr {
  ...
  _$AI(t, r = this) {
    if ((t = Ge(this, t, r, 0) ?? E) === fe) return;
...
const $l = { I: tt }, ec = on.litHtmlPolyfillSupport;
ec?.(Et, tt), (on.litHtmlVersions ??= []).push("3.3.0");
const tc = (e, t, r) => {
  const n = r?.renderBefore ?? t;
  let i = n._$litPart$;
  if (i === void 0) {
    const a = r?.renderBefore ?? null;
    n._$litPart$ = i = new tt(t.insertBefore(xt(), a), a, void 0, r ?? {});
  }
  return i._$AI(e), i;
};
/**
...
let ft = class extends Ke {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = tc(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
ft._$litElement$ = !0, ft.finalized = !0, ln.litElementHydrateSupport?.({ LitElement: ft });
const rc = ln.litElementPolyfillSupport;
rc?.({ LitElement: ft });
(ln.litElementVersions ??= []).push("4.2.0");
class nc extends Zl(ft) {
}
class ic extends nc {
  constructor() {
...
function ac() {
  we.push(import("./copilot-log-plugin-NHihAwdM.js")), we.push(import("./copilot-info-plugin-CVhxCgNh.js")), we.push(import("./copilot-features-plugin-CWvWx_bf.js")), we.push(import("./copilot-feedback-plugin-DngVfw6M.js")), we.push(import("./copilot-shortcuts-plugin-DdIUsnTA.js"));
}
function oc() {
  {
    const e = `https://cdn.vaadin.com/copilot/${il}/copilot-plugins${al}.js`;
    import(
      /* @vite-ignore */
      e
    ).catch((t) => {
...
class lc {
  constructor() {
    this.active = !1, this.activate = () => {
      ...
      this.active && (t.preventDefault(), t.stopPropagation(), ue(t.target) || requestAnimationFrame(() => {
...
const Mt = new lc(), w = window.Vaadin.copilot.eventbus;
if (!w)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const qe = window.Vaadin.copilot.overlayManager, Kd = {
...
const Bd = Sa(Fr), Nt = window.Vaadin.copilot._machineState;
if (!Nt)
  throw new Error("Trying to use stored machine state before it was initialized");
const cc = 5e3;
let ei = 1;
function Da(e) {
  b.notifications.includes(e) && (e.dontShowAgain && e.dismissId && dc(e.dismissId), b.removeNotification(e), w.emit("notification-dismissed", e));
}
function Na(e) {
...
function pc() {
  ...
  return dn() ? qr(Ve`${e} <br />${cn()}`) : qr(Ve`${e}`);
}
function cn() {
  return dn() ? Ve`<vaadin-button
      theme="primary"
      @click=${(e) => {
    const t = e.target;
...
function fc(e) {
  ...
  return b.setNotifications([...b.notifications, r]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    Da(r);
  }, e.delay ?? cc), w.emit("notification-shown", e), r;
}
const vc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  dismissNotification: Da,
  getRestartRequiredMessage: pc,
  renderRestartButton: cn,
  showNotification: Ta
}, Symbol.toStringTag, { value: "Module" })), br = window.Vaadin.copilot._earlyProjectState;
if (!br)
...
function hc() {
  hr(`${Ne}plugin-restart-application`, {}, () => {
  }).catch((e) => {
    ze("Error restarting server", e);
  });
}
function Ar(e) {
  if (e === void 0)
...
function ze(e, t) {
  const r = Ar(t) ? t.exceptionMessage ?? t.message : t, n = {
    type: et.ERROR,
    message: "Copilot internal error",
    details: e + (r ? `
${r}` : "")
  };
  Ar(t) && t.suggestRestart && dn() && (n.details = qr(Ve`${e}<br />${r} ${cn()}`), n.delay = 3e4), rn(n);
  let i;
  t instanceof Error ? i = t.stack : Ar(t) ? i = t?.exceptionStacktrace?.join(`
`) : i = t?.toString(), w.emit("system-info-with-callback", {
    callback: (a) => w.send("copilot-error", {
...
function gc() {
  ...
  if (Array.isArray(t))
    for (const r of t)
      Array.isArray(r) ? Sr.push(...r) : Sr.push(r);
  mc((r) => Sr.push(r));
}
const Sr = [];
function mc(e) {
  ...
  window.Vaadin.ConsoleErrors = {
    push: (r) => {
      r[0] === null || r[0] === void 0 || (r[0].type !== void 0 && r[0].message !== void 0 ? e({
        ...
        details: r[0].details,
        link: r[0].link
      }) : e({ type: et.ERROR, message: r.map((n) => bc(n)).join(" "), internal: !1 }), t.push(r));
    }
  };
}
function bc(e) {
...
const Va = () => {
  yc().then((e) => b.setUserInfo(e)).catch((e) => ze("Failed to load userInfo", e));
}, yc = async () => hr(`${Ne}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const za = Symbol.for(""), wc = (e) => {
  if (e?.r === za) return e?._$litStatic$;
}, Ia = (e) => ({ _$litStatic$: e, r: za }), ri = /* @__PURE__ */ new Map(), xc = (e) => (t, ...r) => {
  const n = r.length;
  let i, a;
  const o = [], s = [];
  let l, c = 0, d = !1;
  for (; c < n; ) {
    for (l = t[c]; c < n && (a = r[c], (i = wc(a)) !== void 0); ) l += i + t[++c], d = !0;
    c !== n && s.push(a), o.push(l), c++;
  }
  if (c === n && o.push(t[n]), d) {
    const u = o.join("$$lit$$");
    (t = ri.get(u)) === void 0 && (o.raw = o, ri.set(u, t = o)), r = s;
  }
  return e(t, ...r);
}, vt = xc(Ve);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Oc } = $l, Fd = (e) => e.strings === void 0, ni = () => document.createComment(""), ot = (e, t, r) => {
  const n = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (r === void 0) {
    const a = n.insertBefore(ni(), i), o = n.insertBefore(ni(), i);
    r = new Oc(a, o, e, e.options);
  } else {
  ...
  return r;
}, ye = (e, t, r = e) => (e._$AI(t, r), e), Ec = {}, kc = (e, t = Ec) => e._$AH = t, Cc = (e) => e._$AH, Pr = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const ii = (e, t, r) => {
  ...
  update(e, [t, r, n]) {
    const i = Cc(e), { values: a, keys: o } = this.dt(t, r, n);
    if (!Array.isArray(i)) return this.ut = o, a;
    const s = this.ut ??= [], l = [];
    let c, d, u = 0, v = i.length - 1, h = 0, m = a.length - 1;
    for (; u <= v && h <= m; ) if (i[u] === null) u++;
    else if (i[v] === null) v--;
    else if (s[u] === o[h]) l[h] = ye(i[u], a[h]), u++, h++;
    else if (s[v] === o[m]) l[m] = ye(i[v], a[m]), v--, m--;
    else if (s[u] === o[m]) l[m] = ye(i[u], a[m]), ot(e, l[m + 1], i[u]), u++, m--;
    else if (s[v] === o[h]) l[h] = ye(i[v], a[h]), ot(e, i[u], i[v]), v--, h++;
    else if (c === void 0 && (c = ii(o, h, m), d = ii(s, u, v)), c.has(s[u])) if (c.has(s[v])) {
      const O = d.get(o[h]), A = O !== void 0 ? i[O] : null;
      if (A === null) {
        const G = ot(e, i[u]);
        ye(G, a[h]), l[h] = G;
      } else l[h] = ye(A, a[h]), ot(e, i[u], A), i[O] = null;
      h++;
    } else Pr(i[v]), v--;
    else Pr(i[u]), u++;
    for (; h <= m; ) {
    ...
    return this.ut = o, kc(e, l), fe;
  }
}), Bt = /* @__PURE__ */ new Map(), Ac = (e) => {
  ...
  return vt`
    ...
    (n) => {
      ...
      return vt` <copilot-section-panel-wrapper panelTag="${i}">
          ${se.shouldRender(n.tag) ? vt`<${i} slot="content"></${i}>` : E}
  ...
  r && e.panelInfo?.panel && Bt.set(t, r);
}, Wd = (e) => {
...
const Tc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), ai = { randomUUID: Tc };
function Vc(e, t, r) {
  e = e || {};
  const n = e.random ?? e.rng?.() ?? Nc();
  if (n.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return n[6] = n[6] & 15 | 64, n[8] = n[8] & 63 | 128, Pc(n);
}
function La(e, t, r) {
  return ai.randomUUID && !e ? ai.randomUUID() : Vc(e);
}
const Ft = [], dt = [], Hd = async (e, t, r) => {
  let n, i;
  t.reqId = La();
...
const si = new Yc(), Qc = "copilot-development-setup-user-guide";
function Gd() {
  yt("use-dev-workflow-guide"), se.updatePanel(Qc, { floating: !0 });
}
function Ra() {
  const e = br.jdkInfo;
...
function Yd() {
  const e = br.jdkInfo;
  return !e || Ra() !== "success" ? "none" : e.jrebel ? "jrebel" : e.runningWitHotswap ? "hotswap" : "none";
}
function _c() {
...
function $c() {
  te(`${Ne}get-dev-setup-info`, {}), window.Vaadin.copilot.eventbus.on("copilot-get-dev-setup-info-response", (e) => {
    if (e.detail.content) {
...
class ed {
  constructor() {
    this.root = null, this.nodeUuidNodeMapFlat = /* @__PURE__ */ new Map(), this.aborted = !1, this._hasFlowComponent = !1, this.flowNodesInSource = {}, this.flowCustomComponentData = {}, this.hillaCustomComponentData = {}, this.componentDragDropApiInfosMap = {}, this.waitForHillaCustomComponentResponseData = () => new Promise((t, r) => {
      ...
      w.emit("request-hilla-custom-component-data-with-callback", {
        tree: this,
        callback: (i) => {
          clearTimeout(n), t(i);
        }
  ...
  includeReactNode(t) {
    return ct(t) === "PreconfiguredAuthProvider" || ct(t) === "RouterProvider" ? !1 : Nn(t) || nl(t);
  }
  async includeFlowNode(t) {
    if (ll(t) || It(t)?.hiddenByServer)
      return !1;
    const r = It(t);
    return r && this.nodeUuidNodeMapFlat.has(li(r)) ? !1 : this.isInitializedInProjectSources(t);
  }
  async isInitializedInProjectSources(t) {
    ...
    if (!this.flowNodesInSource[i]) {
      const a = await hr("copilot-get-component-source-info", { uiId: i }, (o) => o.data);
      a.error && ze("Failed to get component source info", a.error), this.flowCustomComponentData[i] = a.customComponentResponse, this.flowNodesInSource[i] = new Set(a.nodeIdsInProject), this.componentDragDropApiInfosMap[i] = a.dragDropApiInfos;
    }
    ...
    if (r)
      ...
      if (!a) {
        ...
        if (i ? a = this.generateNodeFromFlow(t) : a = this.generateNodeFromFiber(t), !a)
          return ze("Unable to add node", new Error("Tree root node is undefined")), !1;
        a.abstractRootNode = !0;
      }
      this.root = a;
    }
    a && this.nodeUuidNodeMapFlat.set(a.uuid, a);
    const o = a ?? r, s = i ? Array.from(t.children) : el(t);
    for (const l of s)
      await this.addToTree(l, o);
    return a !== void 0;
  }
  generateNodeFromFiber(t, r) {
    const n = Nn(t) ? rr(t) : void 0, i = r?.children.length ?? 0, a = this;
    return {
      node: t,
      parent: r,
      element: n,
  ...
  generateNodeFromFlow(t, r) {
    ...
    return {
      ...
      get name() {
        return ol(n) ?? In(n.element.localName);
      },
      get identifier() {
        return Un(t);
      },
...
const Zr = (e) => {
  if (Nt.isActivationShortcut())
    if (e.key === "Shift" && !e.ctrlKey && !e.altKey && !e.metaKey)
      ...
      if (lt++, lt === 2)
        return b.toggleActive("shortcut"), lt = 0, !0;
      setTimeout(() => {
        lt = 0;
      }, 500);
    } else
...
function ad(e) {
  const t = wt(e, "vaadin-context-menu-overlay");
  if (!t)
    return !1;
  const r = t.owner;
  return r ? !!wt(r, "copilot-component-overlay") : !1;
}
function od() {
...
const fi = (e) => {
  ...
  if (!t)
    return;
  const r = ad(t), n = t.localName === "copilot-main", i = wt(t, "copilot-outline-panel") !== null;
  ...
  if (pi(e))
    ...
    if (b.loginCheckActive ? b.setLoginCheckActive(!1) : w.emit("close-drawers", {}), ld(t)) {
      e.stopPropagation();
      return;
    }
    w.emit("escape-key-pressed", { event: e });
  } else sd(e) ? (w.emit("delete-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "d" ? (w.emit("duplicate-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "b" ? (w.emit("show-selected-in-ide", { attach: e.shiftKey }), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "z" && od() ? (w.emit("undoRedo", { undo: !e.shiftKey }), o = !0) : pi(e) || w.emit("keyboard-event", { event: e });
  a && e.stopPropagation(), o && e.preventDefault();
}, sd = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey;
function ld(e) {
  const t = e;
  if (Mn(e))
    return !0;
...
var cd = Object.getOwnPropertyDescriptor, dd = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? cd(t, r) : t, a = e.length - 1, o; a >= 0; a--)
    (o = e[a]) && (i = o(i) || i);
  return i;
};
let vi = class extends ic {
  constructor() {
    super(...arguments), this.removers = [], this.initialized = !1, this.active = !1, this.overlayListener = (e) => {
      ...
      if (this.promoteActivationButtonLayerIndex(t), !!b.active) {
        if (ue(t)) {
          const r = qe.getOwner(t);
          r && this.addDescendantOverlayOwnersToDrawer(r);
          return;
        }
        this.ensureTopmostPopover(t);
      }
      ...
      if (!e)
        return;
      const t = wt(e, "copilot-drawer-panel") ?? void 0;
      if (t)
        return t;
    }, this.toggleOperationInProgressAttr = () => {
      this.toggleAttribute("operation-in-progress", b.operationWaitsHmrUpdate !== void 0);
    }, this.operationInProgressCursorUpdateDebounceFunc = Gc(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
      ue(e.target?.owner) || (b.active || ue(e.detail.sourceEvent.target)) && e.preventDefault();
    }, this.mouseLeaveListener = () => {
      w.emit("close-drawers", {});
    };
  }
  static get styles() {
    return [
  ...
  connectedCallback() {
    super.connectedCallback(), this.popover = "manual", this.ensureTopmostPopover(), document.body.addEventListener("vaadin-overlay-open", this.overlayListener), document.documentElement.addEventListener("vaadin-overlay-close", this.overlayCloseEventListener), this.init().catch((e) => ze("Unable to initialize copilot", e));
  }
  ensureTopmostPopover(e) {
    this.isConnected && (this.hidePopover(), this.showPopover(), this.promoteActivationButtonLayerIndex(e));
  }
  promoteActivationButtonLayerIndex(e) {
    if (e && wt(e, "copilot-activation-button") !== null)
      return;
    const t = this.shadowRoot.querySelector("copilot-activation-button");
    t?.popover && (t.hidePopover(), t.showPopover());
  }
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-hhtw0bTE.js"), await import("./copilot-init-step2-DjYJaFPA.js"), vl(), ac(), this.tabIndex = 0, Mt.hostConnectedCallback(), window.addEventListener("keydown", Zr), this.addEventListener("keydown", fi), w.onSend(this.handleSendEvent), this.removers.push(w.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
      w.on("open-attention-required-drawer", this.openDrawerIfPanelRequiresAttention.bind(this))
    ), this.removers.push(
      w.on("set-pointer-events", (r) => {
        this.style.pointerEvents = r.detail.enable ? "" : "none";
      })
    ), this.addEventListener("mousemove", this.mouseMoveListener), this.addEventListener("dragover", this.dragOverListener), this.addEventListener("dragleave", this.dragLeaveListener), this.addEventListener("drop", this.dropListener), qe.addOverlayOutsideClickEvent();
    ...
    this.classList.toggle("dark", e.matches), e.addEventListener("change", (r) => {
      ...
      () => b.active,
      () => {
        this.toggleAttribute("active", b.active), b.active ? this.activate() : this.deactivate(), Ze.saveCopilotActivation(b.active);
      }
    ), this.reaction(
    ...
    ), Ze.getCopilotActivation() && ua().then(() => {
      ...
      w.on("vaadin-drawer-opened-changed", (r) => {
    ...
    const t = new ResizeObserver(() => {
      w.emit("copilot-main-resized", {});
    });
    t.observe(this), this.removers.push(() => {
      t.disconnect();
    }), gc(), this.detectAppTheme(), this.initialized = !0, $c();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    Mt.activate(), si.copilotActivated(), sc(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), qe.onCopilotActivation(), await td(), this.ensureTopmostPopover(), this.active = !0, Nt.isActivationAnimation() && b.activatedFrom !== "restore" && this.getAllDrawers().forEach((e) => {
  ...
  deactivate() {
    ...
    }), this.closeDrawers(), Mt.deactivate(), si.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), qe.onCopilotDeactivation(), this.active = !1;
  }
  getAllDrawers() {
    return Array.from(this.shadowRoot.querySelectorAll("copilot-drawer-panel"));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Mt.hostDisconnectedCallback(), window.removeEventListener("keydown", Zr), this.removeEventListener("keydown", fi), w.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.dragOverListener), this.removeEventListener("dragleave", this.dragLeaveListener), this.removeEventListener("drop", this.dropListener), qe.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener), document.body.removeEventListener("vaadin-overlay-open", this.overlayListener), document.documentElement.removeEventListener("vaadin-overlay-close", this.overlayCloseEventListener);
  }
  handleSendEvent(e) {
  ...
  renderDrawer(e) {
    return Ve` <copilot-drawer-panel position=${e}> ${Ac(e)} </copilot-drawer-panel>`;
  }
  /**
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), Ic();
  }
  ...
  mouseMoveListener(e) {
    e.composedPath().find((t) => t.localName === `${Ne}drawer-panel`) || this.closeDrawers();
  }
  dragOverListener(e) {
    this.mouseMoveListener(e), e.dataTransfer && (e.dataTransfer.dropEffect = "none"), e.preventDefault(), w.emit("drag-and-drop-in-progress", {});
  }
  dragLeaveListener(e) {
    Cl(e) && w.emit("end-drag-drop", {});
  }
  dropListener(e) {
    e.preventDefault(), w.emit("end-drag-drop", {});
  }
  detectAppTheme() {
    Tn("lumo") ? b.setAppTheme("lumo") : Tn("aura") ? b.setAppTheme("aura") : b.setAppTheme(null), hr(`${Ne}set-app-theme`, { theme: b.appTheme }, () => {
    });
  }
};
vi = dd([
...
function tu(e, t, r) {
  return Ka(e, r).map((n) => fd(n, t)).filter((n) => n !== void 0);
}
export {
  fl as $,
  zl as A,
