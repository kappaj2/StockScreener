...
public class OllamaBreakoutAnalyser {
     ...
     * @param premarketHigh highest price seen during pre-market for this symbol
    ...
    public CompletableFuture<BreakoutAnalysis> analyseAsync(
        ...
        try {
            ...
            String prompt = """
                    You are a pre-market breakout analyst. Analyse these 1-min bars for %s.
                    Pre-market high: %.4f | Avg candle range: %.4f | Avg volume: %.0f
                    ...
                    """.formatted(symbol, premarketHigh, avgRange, avgVolume, barsJson);
